...
export default function PadelTournamentPage() {
  ...
  const updateScore = (
    ...
    // recalc points
    const fresh = players.map((p) => ({ ...p, points: 0 }));
        ...
        <div className="space-y-4">
          ...
          {(() => {
            ...
            return waiting.length > 0 ? (
              <div className="p-3 bg-yellow-50 border border-yellow-300 rounded text-sm font-medium">
                Waiting players: {waiting.map((p) => p.name).join(", ")}
              </div>
            ) : null;
          })()}
          ...
          {/* Games grid: always 2 cols on large */}
            ...
            {currentRound.games.map((g) => (
              ...
              >
                ...
                <CardContent>
                  ...
                  <div className="p-2 rounded bg-green-50 mt-2">
